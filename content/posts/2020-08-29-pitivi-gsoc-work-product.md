...
A brief explanation of the `cvtracker` element can be found on my blog post: [cvtracker: OpenCV object tracking plugin](https://bannawandoor27.github.io/2020/08/15/gstreamer-cvtracker.html)
...
[Pitivi: Object Tracking](https://bannawandoor27.github.io/2020/07/28/pitivi-object_tracking.html)

As the project progressed, we iterated and made a lot of UI improvements. A demo with the explanation can be found here: [Pitivi: Edit Object Tracking](https://bannawandoor27.github.io/2020/08/16/pitivi-object_track_editing.html)
